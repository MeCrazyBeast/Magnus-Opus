...
Original file is located at
    https://colab.research.google.com/drive/1xiCCCWPFfrjtxzbf-ifFayR8MoAxUrYK
"""
...
class Play:
  ...
  #Play:
    while(True):
      ...
      if ((self.human.remainingWicket==0 or self.human.remainingOver==0 and self.human.remainingBalls==0
          and self.bot.remainingWicket!=0) or 
         (self.bot.remainingWicket==0 or self.bot.remainingOver==0  and self.bot.remainingBalls==0
          and self.human.remainingWicket!=0)):
          print("Pog")
